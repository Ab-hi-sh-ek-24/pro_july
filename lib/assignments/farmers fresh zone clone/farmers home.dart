...
import 'package:pro_july/assignments/farmers%20fresh%20zone%20clone/farmers%20widget.dart';
import 'package:sliding_clipped_nav_bar/sliding_clipped_nav_bar.dart';

import 'blog farmers widget.dart';
void main(){
  runApp(MaterialApp(
    home: Farmers_Home(),
...
class Farmers_Home extends StatefulWidget {


  @override
  State<Farmers_Home> createState() => Farmers_HomeState();
}
var selectedIndex=0;
...
class Farmers_HomeState extends State<Farmers_Home> {
  @override
            ...
            delegate: SliverChildBuilderDelegate(
                ...
                if (index == 0) {
                  return GridView.builder(
                    ...
                    // Number of images
                    itemBuilder: (BuildContext context, int gridIndex) {
                      return FarmersWidget(image: NetworkImage(buyimg[gridIndex]),
